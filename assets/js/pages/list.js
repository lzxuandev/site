  ...
  var categories = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'The Legend of 1900', image: '' },
        { title: 'The Pianist', image: '' },
        ...
        { title: 'The Shining', image: '' },
        { title: 'Joker', image: '' },
        { title: 'Sherlock Holmes(2009)', image: '' },
        { title: 'Dracula', image: '' },
        { title: 'Harry Potter and the Sorcerer\'s Stone', image: '' },
        { title: 'Harry Potter and the Chamber of Secrets', image: '' },
        { title: 'Harry Potter and the Prisoner of Azkaban', image: '' },
        { title: 'Ip Man', image: ''},
        { title: 'Harry Potter and the Goblet of Fire', image: '' },
        { title: 'Harry Potter and the Order of the Phoenix', image: '' },
        { title: 'Harry Potter and the Half-Blood Prince', image: '' },
        ...
        { title: 'A Chinese Odyssey Part One - Pandora\'s Box (大话西游之月光宝盒)', image: '' },
        { title: 'A Chinese Odyssey Part Two - Cinderella (大话西游之大圣娶亲)', image: '' },
        ...
        { title: 'Final Destination', image: '' },
        { title: 'Pacific Rim', image: '' },
    ...
    },
    {
      ...
      title: 'Series',
      items: [
        { title: 'Breaking Bad', image: '' },
        { title: 'Loki', image: '' },
        { title: 'Moon Knight', image: '' },
        { title: 'The Walking Dead', image: ''},
        { title: 'Sherlock', image: '' },
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'Limitless', image: '' },
        { title: '不便的便利店', image: '' },
        { title: '焦虑的人', image: '' },
        { title: 'C Programming: A Modern Approach', image: '' },
        { title: 'Head First C', image: '' },
        { title: '吃土', image: '' },
        { title: '雪洞', image: '' },
        { title: '深度工作', image: '' },
      ],
